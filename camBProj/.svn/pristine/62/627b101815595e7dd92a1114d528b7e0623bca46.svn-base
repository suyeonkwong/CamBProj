...
<div id="body">
	...
	<div class="card shadow mb-4">
		...
		<div class="card-body">
			...
			<label>총 <span class="text-info">${takeOffApplyCount.totalCnt}</span> 개의 신청 내역이 있습니다. </label>
			<div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4">
				...
				<div class="row">
					<div class="col-sm-12 text-right">
						<button type="button" id="btnInsert" class="btn btn-primary btn-primary-crud" onclick="location.href='/student/takeOff/takeOffApply?pageNo=${param.pageNo}'">신청</button>
					</div> <!-- //end button -->
				</div>
			</div>
