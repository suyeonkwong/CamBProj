                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow d-sm-none">
                            <a class="nav-link dropdown-toggle" href="/resources/sbadmin/#" id="searchDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <!-- Nav Item - Messages -->
                        <li class="nav-item dropdown no-arrow mx-1">
                            <a class="nav-link dropdown-toggle" href="/resources/sbadmin/#" id="messagesDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="messagesDropdown">
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="/resources/sbadmin/#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="/resources/sbadmin/img/undraw_profile_1.svg" alt="...">
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="/resources/sbadmin/#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="/resources/sbadmin/img/undraw_profile_2.svg" alt="...">
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="/resources/sbadmin/#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="/resources/sbadmin/img/undraw_profile_3.svg" alt="...">
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="/resources/sbadmin/#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="/resources/sbadmin/https://source.unsplash.com/Mv9hjnEUHR4/60x60" alt="...">
                                        <div class="status-indicator bg-success"></div>
                                    </div>
                                    <div>
                                        <div class="text-truncate">
                                ...
                                <a class="dropdown-item text-center small text-gray-500" href="/resources/sbadmin/#">Read More Messages</a>
                            </div>
                        </li>
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="/resources/sbadmin/#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Douglas McGee</span>
                                <img class="img-profile rounded-circle" src="/resources/sbadmin/img/undraw_profile.svg">
                            </a>
                            <!-- Dropdown - User Information -->
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                                <a class="dropdown-item" href="/resources/sbadmin/#">
                                ...
                                <a class="dropdown-item" href="/resources/sbadmin/#" data-toggle="modal" data-target="#logoutModal">
