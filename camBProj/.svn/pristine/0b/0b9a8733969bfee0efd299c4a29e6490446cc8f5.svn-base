package kr.or.ddit.util.CryptoUtil;
...
public class CryptoUtil {
	 ...
	 */
	public static String sha512(String authNo) throws UnsupportedEncodingException, NoSuchAlgorithmException {
		// length 88
		MessageDigest md = MessageDigest.getInstance("SHA-512");
		md.update(authNo.getBytes("UTF-8"));
