...
<c:if test="${sessionScope.admin == '03'}">
	<div class="card shadow mb-4" style="width:100%;">
		...
		<form action="/common/deptNotice/deptNoticeUpdate" method="post" id="updateFrm" enctype="multipart/form-data">
					...
					<div class="col-sm-12">  
						<table class="table" id="dataTable" cellspacing="0" role="grid"
							...
							<tr role="row">
								...
								<td class="sorting_1">
									<input type="text" id="empId" name="empId" class="form-control" value="${dv.empId}" readonly="readonly">
								</td>
							</tr>
							<tr>
								...
								<td>
									<input type="text" id="title" name="title" class="form-control" value="${dv.title}" maxlength="50">
								</td>
							</tr>
							<tr class="even">
								<th class="sorting" tabindex="0" aria-controls="dataTable"
							...
							<td>
								<textarea id="contentE" name="content" maxlength="1000">${dv.content}</textarea>
							</td>
							</tr>
							<tr class="even">
								<th class="sorting" tabindex="0" aria-controls="dataTable"
								...
								<td>					
								<select name="uniDepCode" id="uniDepCode" class="form-control">
							...
							<tr class="odd">
								...
								<td><input type="date" id="modDate" name="modDate" class="form-control" disabled="disabled"
									value="${dv.modDate}"></td>
							</tr>
							<tr>
								<th class="sorting" tabindex="0" aria-controls="dataTable"
										...
										<div id="setFileName">
											...
											<br>
												<div style="margin-top: 5px;">
													...
													<a href="/filePath=${getFile.filePath}"
				...
				&nbsp;&nbsp;&nbsp;
				<div style="float: right; position: relative; left: 1320px;">
