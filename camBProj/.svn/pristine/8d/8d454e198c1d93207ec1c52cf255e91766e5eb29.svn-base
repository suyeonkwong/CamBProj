                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
						...
						<ul class="navbar-nav mr-auto ">
	                        ...
	                        <!-- 공지사항 시작 -->
	                       	<li class="nav-item dropdown no-arrow headNavLi">
	                            <a class="nav-link dropdown-toggle headNavA" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" >
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <c:if test="${sessionScope.memberVo.memId==null}">
                        	<li class="nav-item headNavLi">      
                                <a class="headNavA" href="/common/login">
                                <i class="fas fa-dot-circle mr-2"></i>
                                	로그인
                                </a>  
                            </li>
