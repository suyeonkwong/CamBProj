...
<div id="body">
	...
	<div class="card shadow mb-4">
		...
		<div class="card-header py-3">
			<h6 class="m-0 font-weight-bold text-primary">복수전공 신청</h6>
		</div>
		...
		<div class="col-sm-12">
			<div class="card shadow mb-4">
				...
				<a href="#collapseCardExample1" class="d-block card-header py-3" data-toggle="collapse" role="button" aria-expanded="true" aria-controls="collapseCardExample">
					<h6 class="m-0 font-weight-bold text-primary">복수전공 안내</h6>
				</a>
...
<script type="text/javascript">
	...
	function univDeptSearch() {
		var stdId = $("#stdId").val();
		window.open("/student/courseChange/univDeptSearchPopup?stdId=" + stdId +"&courseChngCode=02", "owin", "width=1000, height=700");
	}
