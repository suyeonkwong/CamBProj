...
<c:if test="${sessionScope.admin == '03'}">
	<div class="card shadow mb-4" style="width: 100%;">
		<div class="card-header py-3">
			<h6 class="m-0 font-weight-bold text-primary">학과 공지사항 등록</h6>
		</div>
		<div class="card-body">

				<form action="/common/deptNotice/deptNoticeInsert" method="post" enctype="multipart/form-data" id="depFrm">
					<!-- form start -->
				<table class="table" id="dataTable" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%;">
								...
								<tr class="even">
									...
									<td colspan="3" style="height: 500px;"><textarea id="contentE" name="content" maxlength="1000R">본문입니다.</textarea><br>
									</td>
								...
								<tr>
									...
									<td>
										...
										<div class="col-sm-6">
											<div class="form-group">
												 <select name="uniDepCode"
													id="uniDepCodes" class="form-control">
