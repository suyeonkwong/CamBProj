                	...
                	<div class="row">
                		<div class="col-xl-12 col-lg-12">
                			...
                			<div class="card shadow mb-4">
                               ...
                               <div class="card-body">
                                   <!-- 학적 변동 신청 대기 상태 -->
									<div class="vertical px-3 py-2 bg-primary btnFade text-white" style="border-radius: 5px; height:40px;" onclick="location.href='/student/takeOff/takeOffApplyList'">
	                               		<div style="margin-left: 10px;">
	                               			<i class="fas fa-chevron-circle-right mr-2"></i> 학적 변경 신청 정보
	                               		</div>
	                               	</div>
	                               			...
	                               			<div class="row no-gutters align-items-center" style="margin-bottom: 10px;">
		                                        <div class="col mr-2">
		                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
		                                            	<label class="badge badge-warning" style="cursor: pointer;" onclick="location.href='/student/takeOff/takeOffApplyList'">
		                                            		<span class="text-gray-800">휴학</span> ${jobCountVo.takeOffCnt01}/${jobCountVo.takeOffCntTotal} 건 대기
		                                            	</label>
		                                            	<label class="badge badge-warning" style="cursor: pointer;" onclick="location.href='/student/return/returnApplyList'">
		                                            		<span class="text-gray-800">복학</span> ${jobCountVo.returnCnt01}/${jobCountVo.returnCntTotal} 건 대기
		                                            	</label>
		                                            	<label class="badge badge-warning" style="cursor: pointer;" onclick="location.href='/student/readmission/readmApplyList'">
		                                            		<span class="text-gray-800">재입학</span> ${jobCountVo.readmissionCnt01}/${jobCountVo.readmissionCntTotal} 건 대기
		                                            	</label>
		                                            	<label class="badge badge-warning" style="cursor: pointer;" onclick="location.href='/student/expulsion/expulsionApplyList'">
		                                            		<span class="text-gray-800">퇴학</span> ${jobCountVo.expulsionCnt01}/${jobCountVo.expulsionCntTotal} 건 대기
		                                            	</label>
		                                            	<label class="badge badge-warning" style="cursor: pointer;" onclick="location.href='/student/courseChange/courseChangeApplyList'">
		                                            		<span class="text-gray-800">이수변경</span> ${jobCountVo.courseChangeCnt01}/${jobCountVo.courseChangeCntTotal} 건 대기
		                                            	</label>
		                                            </div>
		                                        </div>
		                                        <div class="col-auto">
                                   ...
                                   <!-- 미납된 등록금 내역 -->
                                   <div class="vertical px-3 py-2 bg-primary btnFade text-white" style="border-radius: 5px; height:40px;" onclick="location.href='/student/tuitionPayment/tuitionPaymentList'">
	                               		<div style="margin-left: 10px;">
	                               			<i class="fas fa-chevron-circle-right mr-2"></i> 등록금 정보
	                               		</div>
	                               	</div>
	                               	<div class="px-3 bg-gray-100" style="margin-bottom: 20px; border-radius: 5px; padding: 20px;">
	                               		<div style="margin-left: 10px;" >
	                               			<div class="row no-gutters align-items-center" style="margin-bottom: 10px;">
		                                        <div class="col mr-2">
		                                            ...
		                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
		                                            <a href="/student/tuitionPayment/tuitionPaymentList">
		                                            	<label class="text-info" style="cursor: pointer;">${jobCountVo.tuitionPaymentCnt01}</label>
		                                            </a>	
		                                            	건의 등록금 미납 내역이 있습니다. 
		                                            </div>
		                                        </div>
                           ...
                           <div class="card shadow mb-4">
	                           <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
	                               <h6 class="m-0 font-weight-bold text-primary">이수 학점</h6>
	                           </div>
	                           <div class="card-body">
	                           		<div class="card-body">
                ...
                <div class="col-xl-4 col-lg-4">
                	<div class="row">
                		<div class="col-xl-12 col-lg-12">
                			...
                			<div class="card shadow mb-4">
                               ...
                               <div class="card-body text-center">
                               	<label style="font-size: 1.2em;" class="badge badge-light">
                               		...
                               		<c:if test="${yearAndSem.year != null && yearAndSem.year != ''}">
	                               		<span>${yearAndSem.year}</span>년 
	                               		<span>${yearAndSem.sem}</span>학기
                               		</c:if>
                               	</label>
                               	<c:if test="${yearAndSem.year == null || yearAndSem.year == ''}">
                           ...
                           <div class="card shadow mb-4">
	                           <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
	                               <h6 class="m-0 font-weight-bold text-primary">봉사 시간</h6>
	                           </div>
	                           <div class="card-body">
	                           		<div class="card-body">
	                           			...
	                           			<div class="row no-gutters align-items-center" style="margin-bottom: 10px;">
	                                        <div class="col mr-2">
	                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
			                           				<a href="/student/volunteer/volunteerList"><label class="text-info" style="cursor: pointer;">${volunteerVo.volRecogTimeSum}</label></a>
			                           				 / 
			                           				<a href="/student/volunteer/volunteerList"><label class="text-info" style="cursor: pointer;">${volunteerVo.volTimeCrt}</label></a>
			                           				 시간의 봉사를 완료하였습니다.
				                           			<c:if test="${volunteerVo.volRecogTimeSumTotal - volunteerVo.volRecogTimeSum > 0}">
					                           			<a href="/student/volunteer/volunteerList"><label class="text-info" style="cursor: pointer;">${volunteerVo.volRecogTimeSumTotal - volunteerVo.volRecogTimeSum}</label></a> 
					                           			시간의 봉사 내역이 승인 대기 중입니다.
				                           			</c:if>
			                           			</div>
	                                        </div>
	                                        <div class="col-auto">
	                           			...
	                           			<div class="progress">
                             				<fmt:parseNumber var="volPercent" value="${volunteerVo.volRecogTimeSum/volunteerVo.volTimeCrt*100}" integerOnly="true"/>
	                                        <div class="progress-bar progress-bar-striped active" role="progressbar" style="width: ${volPercent}%;" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100">
	                                        	${volPercent}%
	                                        </div>
	                                    </div>
	                               </div>
