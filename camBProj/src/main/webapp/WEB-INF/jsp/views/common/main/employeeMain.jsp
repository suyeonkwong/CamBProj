                	...
                	<div class="row">
                		<div class="col-xl-12 col-lg-12">
                			...
                			<div class="card shadow mb-4">
                               ...
                               <div class="card-body">
                                   <!-- QNA 정보 시작 -->
	                               	<div class="vertical px-3 py-2 bg-primary btnFade text-white" style="border-radius: 5px; height:40px;" onclick="location.href='/common/inquiry/inquiryList'">
	                               		<div style="margin-left: 10px;">
	                               			<i class="fas fa-chevron-circle-right mr-2"></i> Q & A 정보
	                               		</div>
	                               	</div>
	                               		...
	                               		<div style="margin-left: 10px;" >
	                               			<div class="row no-gutters align-items-center" style="margin-bottom: 10px;">
		                                        <div class="col mr-2">
		                                            ...
		                                            <a href="/common/inquiry/inquiryList">
		                                            	<label class="text-info" style="cursor: pointer;">${getJobInfo.qnaCnt}</label>
		                                            </a>	
		                                            	건의 질문이 접수되었습니다.
		                                            </div>
		                                        </div>
                                   ...
                                   <!-- 결재 기안 정보 -->
	                               	<div class="vertical px-3 py-2 bg-primary btnFade text-white" style="border-radius: 5px; height:40px;" onclick="location.href='/auth/authDocList'">
	                               		<div style="margin-left: 10px;">
	                               			<i class="fas fa-chevron-circle-right mr-2"></i>결재 기안 정보
	                               		</div>
	                               	</div>
	                               	<div class="px-3 bg-gray-100" style="margin-bottom: 20px; border-radius: 5px; padding: 20px;">
	                               		<div style="margin-left: 10px;" >
	                               			<div class="row no-gutters align-items-center" style="margin-bottom: 10px;">
		                                        <div class="col mr-2">
		                                            ...
		                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
		                                            <a href="/auth/authDocList" class="jobLink">
		                                            	<label class="text-info" style="cursor: pointer;">${getJobInfo.authDocCnt01}</label>
		                                            </a>	
		                                            	건의 기안이 접수되었습니다.
		                                            </div>
		                                        </div>
