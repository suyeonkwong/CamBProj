		...
		<div class="card-body">
				<div id="dataTable_wrapper" class="dataTables_wrapper dt-bootstrap4" style="width: 100%">
					<div class="row">
						...
						<div class="col-sm-12 col-md-6">
							<div class="card-body" style="position: relative; top: 70px; left: 258px;">
								...
								<form method="get" action="/common/deptNotice/deptNoticeList" name="frmSearch" id="frmSearch">


								<div style="width: 450px;">
									<select name="deptCode" id="deptCode" class="form-control">
										<c:forEach var="code" items="${codeList}">
									    	<option value="" disabled selected hidden>학과별 검색</option>
					...
					<div class="row" style="float: right;">
						<c:if test="${sessionScope.admin == '03'}">
							<button
								class="btn btn-primary btn-primary-crud" style="position: relative; float: right;" type="button" onclick="javascript:location.href='/common/deptNotice/deptNoticeInsert'">
								등록
							</button>
						</c:if>
					</div>
