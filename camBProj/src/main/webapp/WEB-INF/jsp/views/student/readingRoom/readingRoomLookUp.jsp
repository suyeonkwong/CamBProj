...
// 				var str = new Array(); 이걸로 선언하면 console에 찍히는게 조금 다름. 
				
				var str = startTime.split("");	//배열의 길이를 구하기 위해
				console.log(str);
				
				if(str.length == 7){
					startTime = startTime.slice(0,6) + "0" +  startTime.slice(6,7);	//값 잘라서 초 앞에 10보다 작으면 0넣기
				}
