				...
				<form action="/student/courseChange/courseChangeApplyUpdate" id="frm" name="frm"  method="post" enctype="multipart/form-data"><!-- form start -->
					...
					<div class="row">
						<div class="col-sm-4">
							<div class="form-group">
								<label>기준 학기</label>
								<input type="text" class="form-control" value="${courseChangeVo.year}-${courseChangeVo.semCode} 학기" readonly/>
							</div>
						</div>
						<div class="col-sm-4">
							<div class="form-group">
						...
						<div class="col-sm-4">
							<div class="form-group">
								<label>학과</label>
								<div class="input-group">
									<input type="text" class="form-control bg-light small" name="korName" id="korName" value="${courseChangeVo.korName}" onclick="univDeptSearch();" readonly/>
									<input type="hidden" name="univDeptNum" value="${courseChangeVo.univDeptNum}" id="univDeptNum" />
									<div class="input-group-append">
		...
		<div class="col-sm-12">
			<div class="card shadow mb-4">
				...
				<div class="collapse show" id="collapseCardExample1" style="">
					<div class="card-body">
						<p>  ◦ 신청 자격 : 3개 정규학기 이상 이수. 20학점 이상 취득</p>
						<p>  ◦ 전과는 학과별로 3학년, 4학년 입학정원의 범위 내에서 선발하되, 전과전형위원회에서 별도로 심의 후 확정한다.</p>
						<p>  ◦ 사범대학 소속학과 및 의과대학 의예과와 간호학과는 모집단위 입학정원 범위 내에서 여석이 있을 경우에 한하여 전입을 허용할 수 있다.</p> 
...
<script type="text/javascript">
	...
	function univDeptSearch() {
		var stdId = $("#stdId").val();
		window.open("/student/courseChange/univDeptSearchPopup?stdId=" + stdId +"&courseChngCode=01", "owin", "width=1000, height=700");
	}
</script>