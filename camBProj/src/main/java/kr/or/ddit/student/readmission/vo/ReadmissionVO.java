package kr.or.ddit.student.readmission.vo;

import kr.or.ddit.util.BaseVO.BaseVO;

public class ReadmissionVO extends BaseVO{
	
	private String readmNum;
	...
	public String getReadmNum() {
		return readmNum;
	}
	public void setReadmNum(String readmNum) {
		this.readmNum = readmNum;
	}
