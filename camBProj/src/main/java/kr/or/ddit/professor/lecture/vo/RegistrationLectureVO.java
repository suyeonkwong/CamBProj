...
public class RegistrationLectureVO {
	...
	private String stdRgstSem;
	private String stdGrade;
	private String lectUnivDeptNum;
	private String lectGrdtnRequYn;
	...
	private List<RegistrationLectureVO> registrationLectureVO;
	...
	public List<RegistrationLectureVO> getRegistrationLectureVO() {
		return registrationLectureVO;
	}
	public void setRegistrationLectureVO(List<RegistrationLectureVO> registrationLectureVO) {
		this.registrationLectureVO = registrationLectureVO;
	}
	...
	public String toString() {
		return "RegistrationLectureVO [stdId=" + stdId + ", lectOpenNum=" + lectOpenNum + ", subjNum=" + subjNum
				+ ", stdRgstSem=" + stdRgstSem + ", stdGrade=" + stdGrade + ", lectUnivDeptNum=" + lectUnivDeptNum
				+ ", lectGrdtnRequYn=" + lectGrdtnRequYn + ", applyDate=" + applyDate + ", stdName=" + stdName
				+ ", lectName=" + lectName + ", attendDate=" + attendDate + ", attendCode=" + attendCode
				+ ", attendNum=" + attendNum + ", pageNo=" + pageNo + ", selectYear=" + selectYear + ", selectSemester="
				+ selectSemester + ", searchKeyword=" + searchKeyword + ", checkSemester=" + checkSemester
				+ ", inputStatus=" + inputStatus + ", registrationLectureVO=" + registrationLectureVO + "]";
	}
